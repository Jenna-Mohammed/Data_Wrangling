...
```
    ...
    ## # i 39 more rows
    ## # i 1 more variable: pups_survive <dbl>
...
```
    ...
    ## # A tibble: 49 x 8
    ##    GROUP LITTer          gd0_weight gd18_weight gd_of_birth pups_born_alive
    ##    <chr> <chr>                <dbl>       <dbl>       <dbl>           <dbl>
    ##  1 Con7  #85                   19.7        34.7          20               3
    ##  2 Con7  #1/2/95/2             27          42            19               8
    ##  3 Con7  #5/5/3/83/3-3         26          41.4          19               6
...
operates on rows - intended to remove/keep rows that you’re interested
in for analysis

need to give it a condition

the real challenge in using filter is finding how you might specify or
coming up with a way to specify the collection of rows that you actually
want to keep
